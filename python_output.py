...
def my_tracer(frame, event, arg=None):
    ...
    if event == 'line':
        ...
        print("<div class = \"div_line_num\">%s</div>" % (str(line_no-491)), "<div class = \"div_code_text\">%s</div>" % (curr_code_html),"<br>")
...
def htmlInit():
    ...
    # NOTE: f:\SPL3 papers\COSPEX-VSCODE\pytracex is replaced with the name of the file by my-second-page.js
    print('''
		<!DOCTYPE html>
		<html>
    <head>
		...
		<h2>Filename : f:\SPL3 papers\COSPEX-VSCODE\pytracex</h2>
    <hr>
